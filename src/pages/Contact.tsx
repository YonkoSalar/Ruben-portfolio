...
function Contact() {
  ...
  return (
    <section className=" bg-black flex flex-col justify-center">
      ...
      <div className="p-10 flex-grow flex flex-col just-center py-24">
        ...
        <div className="text-center">
          <ul className="mt-12 flex flex-wrap gap-x-12 gap-y-6 items-center lg:gap-x-24 text-white justify-center">
